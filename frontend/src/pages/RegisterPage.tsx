      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-3xl font-bold">Plataforma de Reservas</span>
          </div>
        </div>
        ...
        <div className="card">
          ...
          {error && (
            <div className="bg-red-500/10 border border-red-500 text-red-500 px-4 py-3 rounded-lg mb-4 text-sm animate-shake">
              <div className="flex items-center gap-2">
